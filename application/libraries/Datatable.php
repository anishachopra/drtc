<?php
    ...
    class Datatable
    {
        ...
        private $_CI;
        private $_systemOperations = array('VIEW', 'VIEW_ICON', 'EDIT', 'EDIT_ICON', 'RESTORE_ICON', 'DELETE', 'DELETE_ICON', 'PRINT', 'PRINT_ICON', 'OTHER_ICON', 'OTHER_TEXT', 'STATUS_ICON', 'SORT_ICON', 'REQUEST_VIEW_ICON', 'DOWNLOAD', 'DOWNLOAD_ICON');
        ...
        public function make_table($configIndex, $table_config)
        {
            ...
            {
                $css_class = 'class="dyntable table table-bordered dataTable table-hover"';
        ...
        private function _parse_link_caption($valueArr)
        {
            ...
            switch ($operation)
            {
                ...
                case 'DELETE_ICON':
                    ...
                    break;
                case 'DOWNLOAD':
                    $return = 'DOWNLOAD'; // later we will get values from lang
                    break;
                case 'DOWNLOAD_ICON':
