<?php
    ...
    class Commonlib
    {
        ...
        public function emailexists($email)
        {
            ...
            $return = $this->_CI->User_model->user_email_exist($email);

            if ($return != "1")
            {
                $this->_CI->load->model('admin/Artist_model');
                $return = $this->_CI->Artist_model->artist_email_exist($email);

                if ($return != "1")
                {
                    $this->_CI->load->model('admin/Studio_model');
                    $return = $this->_CI->Studio_model->studio_email_exist($email);
                }
            }
            return $return;
        }

        public function studio_name_exists($studio_name)
        {
            $return = "0";

            $this->_CI->load->model('admin/Studio_model');
            $return = $this->_CI->Studio_model->studio_name_exist($studio_name);
        ...
        public function getallcity_array()
        {
            ...
            //p($this->_CI->City_model->getallcity_array());
        ...
        public function get_total_emailtemplate()
        {
            $this->_CI->load->model('Emailtemplate_model');
            return $this->_CI->Emailtemplate_model->get_total_emailtemplate();
        }
...
//        }
        ...
        public function get_total_experitise()
        {
            $this->_CI->load->model('Areaofexperitise_model');
            return $this->_CI->Areaofexperitise_model->get_total_experitise();
        }
        ...
        public function get_total_pagetemplate()
        {
            $this->_CI->load->model('Pagetemplate_model');
            return $this->_CI->Pagetemplate_model->get_total_pagetemplate();
        }

        public function get_total_footercms()
        {
            $this->_CI->load->model('Footercms_model');
            return $this->_CI->Footercms_model->get_total_footercms();
        }
